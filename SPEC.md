...
The canonical visual and tabular Mermaid C4 architecture map is maintained in `docs/architecture/C4.md`.
...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-09-22 | #470    | Fix(assessment): exclude `assessment_collectors.py` (which now holds the regex patterns) from `find_python_files` so the A-O static scan no longer counts its own patterns; also fix PR-Comment-Responder push target and add pytest-asyncio to the architecture-map contract job.                                                                                                                                                                                                                                                                                                                                 |
| 2026-09-10 | -       | Adopt Mermaid C4 architecture-map contract and automated CI verification (#1608): added `docs/architecture/C4.md`, `scripts/architecture_map_contract.py`, `tests/test_architecture_map_contract.py`, and `.github/workflows/architecture-map-contract.yml`.                                                                                                                                                                                                                                                                                                                                                       |
