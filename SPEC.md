...
| ---------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-14 | 1.0.17  | Refactor(#258): decomposed top-5 oversized functions to ≤30 LOC each in `retarget_to_sim.py`, `club_track.py`, `video_ingest.py`, `run_assessment.py`, and `analyze_completist_data.py`; extracted landmark constants, arm-joint helpers, frame-clamping, clip/smooth/derivative methods, and markdown-template builders.                                                                                               |
