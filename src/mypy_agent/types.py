"""Shared data types and constants for the mypy autofix agent."""
...
# Error codes that are safe to suppress with targeted type: ignore
SUPPRESSIBLE_CODES: set[str] = {
    "assignment",
    "arg-type",
    "return-value",
    "attr-defined",
