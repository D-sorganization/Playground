...
class QualityChecker:
    ...
    def __init__(self):
        ...
        self.exclude_patterns = {
            ...
            '.ruff_cache', 'node_modules', 'vendor', '.venv', 'venv',
            '.benchmarks'
        }
        ...
        try:
            with open(file_path, 'r', encoding='utf-8', errors='ignore') as f:
                for line_num, line in enumerate(f, 1):
                    ...
                    if re.search(r'\b(TODO|FIXME|XXX|HACK)\b', line_clean, re.IGNORECASE):
                        self.issues.append((
                            str(file_path), 
                            "placeholder", 
                            line_num, 
            ...
            for line_num, line in enumerate(content.split('\n'), 1):
                ...
                for match in matches:
                    ...
                    self.issues.append((
                        ...
                        "magic_number",
                        line_num,
                        f"Potential magic number: {match.group()} in '{line.strip()[:60]}'"
                    ))
        except Exception as e:
    ...
    def run_checks(self, root_path: Path = None) -> int:
